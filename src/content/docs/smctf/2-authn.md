...
SMCTF는 기본적으로 로그인 없이 문제 리스트를 확인하거나 유저, 팀 등을 조회할 수 있습니다. 하지만 문제 풀이를 위해선 회원가입 및 로그인이 필요하며, 회원가입 시 [가입 인증 키](/smctf/admin/4-key-manage)를 요구합니다.
...
이에 대해선 [가입 인증 키 관리](/smctf/admin/4-key-manage) 문서를 참고해주세요.
