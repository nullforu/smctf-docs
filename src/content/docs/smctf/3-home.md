...
관리자 페이지에서 [시작/종료 시간 및 사이트 설정](/smctf/admin/5-site-config)을 통해 마크다운으로 페이지를 구성하면 기본적인 구성이 가능하지만, 상세한 커스터마이징을 위해선 [nullforu/smctfe](https://github.com/nullforu/smctfe)를 Fork 또는 Clone하여 직접 수정하는 것을 추천드립니다.

![home](images/3-home/image.png)
