...
[관리자 페이지의 문제 생성 탭](/smctf/admin/create-chall)에서 문제를 생성할 때, `Provide stack (container instance)` 옵션을 활성화하면 아래의 두 가지 필드가 추가로 표시됩니다.

![image](images/stack/image.png)
...
- 스택 생성은 1분당 최대 1회로 제한됩니다. 이는 [요청 속도 제한 설정](/smctf/rate-limit) 문서에서도 언급합니다.

위 제한은 모두 백엔드의 [환경 변수](/smctf/envs-cors)나 Container Provisioner의 [환경 변수](/container-provisioner/envs)에서 조정할 수 있습니다. 과도한 스택 생성으로 인한 리소스 낭비와 과부하를 방지하기 위함으로, 불편을 감수하더라도 필수적인 옵션입니다.

**Create Stack**

![image](images/stack/image-2.png)

**Stack Status**

![image](images/stack/image-4.png)
...
![image](images/stack/image-3.png)

**Stack Limit Reached**

![image](images/stack/image-5.png)
