...
![dash3](images/dashboard/image-2.png)

### Manage Stacks

스택 목록을 보다 쉽게 관리할 수 있는 기능을 제공합니다. 이는 SMCTF 플랫폼에서 관리자 페이지에서도 제공되는 기능입니다.

![dash4](images/dashboard/image-4.png)

![dash5](images/dashboard/image-3.png)
