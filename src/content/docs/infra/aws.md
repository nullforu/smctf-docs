...
Kubernetes 오브젝트/리소스는 Helm 차트를 통해 배포되며 자세한 내용은 [Kubernetes 아키텍처](/infra/k8s) 및 [Helm 차트 구성](/infra/helm) 문서를 참조하세요.
...
자세한 내용은 [Terraform 구성](/infra/terraform) 및 [Helm 차트 구성](/infra/helm) 문서를 참조하세요.
